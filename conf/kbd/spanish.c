 ...
 * 	All rights reserved. May not be copied without permission.
 -lgl) */
/*
 * Spanish virtual console keyboard code table.
 *
...
char	tbl_name[] = "Spanish virtual console keyboard table - V1.6";
 ...
 *----  ----   -----  ----   -----  ---    -----  ----   -----  ------- -----*/
{K_1,	0xA7,  0xA6,  none,  none,  0xA7,  0xA6,  A'\\', none,  '\\',	O|T  },
{K_2,	'1',   '!',   none,  none,  A'1',  A'!',  A'|',  none,  '|',	O|T  },
{K_3,	'2',   '"',   none,  none,  A'2',  A'"',  A'@',  none,  '@',	O|T  },
{K_4,	'3',   0xF8,  none,  none,  A'3',  0xF8,  A'#',  none,  '#',	O|T  },
...
{K_13,	0xAD,  0xA8,  none,  none,  0xAD,  0xA8,  none,  none,  none,	O|T  },
/* key 14 undefined */
...
{K_41,	'\'',  0xB1,  none,  none,  A'\'', 0xB1,  A'{',  none,  '{',	O|T  },
{K_42,	0x87,  0x80,  none,  none,  0x87,  0x80,  A'}',  none,  '}',	C|T  },
