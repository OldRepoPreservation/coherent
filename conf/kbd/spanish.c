 ...
 * 	All rights reserved. May not be copied without permission.
 -lgl) */
/*
 * Spanish standard AT keyboard code table.
 *
 *	See header files for definitions and constants.
 *
 *	Version: 1.3, 07/08/91
 */
#include <sys/kbscan.h>
#include <sys/kb.h>

char	tbl_name[] = "Spanish AT keyboard table";
 ...
 *----  ----   -----  ----   -----  ---    -----  ----   -----  ------- -----*/
{K_1,	0xA7,  0xA6,  none,  none,  0xA7,  0xA6,  '\\',  none,  '\\',	O|T  },
{K_2,	'1',   '!',   none,  none,  '1',   '!',   '|',   none,  '|',	O|T  },
{K_3,	'2',   '"',   none,  none,  '2',   '"',   '@',   none,  '@',	O|T  },
{K_4,	'3',   0xF8,  none,  none,  '3',   0xF8,  '#',   none,  '#',	O|T  },
...
{K_41,	'\'',  0xB1,  none,  none,  '\'',  0xB1,  '{',   none,  '{',	O|T  },
{K_42,	0x87,  0x80,  none,  none,  0x87,  0x80,  '}',   none,  '}',	C|T  },
