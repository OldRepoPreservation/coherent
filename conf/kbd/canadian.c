 ...
 * 	All rights reserved. May not be copied without permission.
 -lgl) */
/*
 * Canadian French virtual console keybord code table.
 *
...
char	tbl_name[] = "Canadian French virtual console keyboard table - V1.6";
 ...
 *----  ----   -----  ----   -----  ---    -----  ----   -----  ------- -----*/
{K_1,	'#',   '|',   none,  none,  A'#',  A'|',  A'\\', none,  '\\',	O|T  },
{K_2,	'1',   '!',   none,  none,  A'1',  A'!',  0xF1,  none,  0xF1,	O|T  },
{K_3,	'2',   '"',   none,  none,  A'2',  A'"',  A'@',  none,  '@',	O|T  },
{K_4,	'3',   '/',   none,  none,  A'3',  A'/',  0x9C,  none,  0x9C,	O|T  },
{K_5,	'4',   '$',   none,  none,  A'4',  A'$',  0x9B,  none,  0x9B,	O|T  },
{K_6,	'5',   '%',   none,  none,  A'5',  A'%',  0x0F,  none,  0x0F,	O|T  },
{K_7,	'6',   '?',   none,  none,  A'6',  A'?',  0xAA,  none,  0xAA,	O|T  },
{K_8,	'7',   '&',   none,  none,  A'7',  A'&',  A'|',  none,  '|',	O|T  },
{K_9,	'8',   '*',   none,  none,  A'8',  A'*',  0xFD,  none,  0xFD,	O|T  },
{K_10,	'9',   '(',   none,  none,  A'9',  A'(',  0xFC,  none,  0xFC,	O|T  },
{K_11,	'0',   ')',   none,  none,  A'0',  A')',  0xAC,  none,  0xAC,	O|T  },
{K_12,	'-',   '_',   us,    us,    A'-',  A'_',  0xAB,  A us,  0xAB,	O|T  },
...
{K_17,	'q',   'Q',   dc1,   dc1,   A'q',  A'Q',  none,  A dc1, none,   C|T  },
...
{K_25,	'o',   'O',   si,    si,    A'o',  A'O',  A nak, A nak, nak,	C|T  },
{K_26,	'p',   'P',   dle,   dle,   A'p',  A'P',  A dc4, A dc4, dc4,	C|T  },
{K_27,	'^',   0xB0,  rs,    rs,    A'^',  0xB0,  A'[',  esc,   '[',	O|T  },
{K_28,	none,  0xB1,  none,  none,  none,  0xB1,  A']',  gs,    ']',	O|T  },
...
{K_40,	';',   ':',   none,  none,  A';',  A':',  A'~',  none,  '~',	O|T  },
{K_41,	'`',   '`',   none,  none,  A'`',  A'`',  A'{',  none,  '{',	O|T  },
...
{K_52,	'm',   'M',   cr,    cr,    A'm',  A'M',  0xE6,  0xE6,  0xE6,	C|T  },
{K_53,	',',   ',',   none,  none,  A',',  A',',  none,  none,  none,   O|T  },
{K_54,	'.',   '.',   none,  none,  A'.',  A'.',  none,  none,  none,   O|T  },
{K_55,	0x82,  0x90,  none,  none,  0x82,  0x90,  A'\'', A'\'', '\'',	C|T  },
/* key 56 undefined */
