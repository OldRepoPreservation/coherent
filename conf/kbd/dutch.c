 ...
 * 	All rights reserved. May not be copied without permission.
 -lgl) */
/*
 * Dutch virtual console keyboard code table.
 *
 *	See header files for definitions and constants.
 *
 *	Version: 1.1, 07/02/91
...
char	tbl_name[] = "Dutch virtual console keyboard table - V1.6";
 ...
 *----  ----   -----  ----   -----  ---    -----  ----   -----  ------- -----*/
{K_1,	'@',   nak,   none,  none,  A'@',  A nak, 0xAA,  none,  0xAA,	O|T  },
{K_2,	'1',   '!',   none,  none,  A'1',  A'!',  0xFE,  none,  0xFE,	O|T  },
{K_3,	'2',   '"',   none,  none,  A'2',  A'"',  0xFD,  none,  0xFD,	O|T  },
{K_4,	'3',   '/',   none,  none,  A'3',  A'/',  0xFC,  none,  0xFC,	O|T  },
{K_5,	'4',   '$',   none,  none,  A'4',  A'$',  0xAC,  none,  0xAC,	O|T  },
{K_6,	'5',   '%',   none,  none,  A'5',  A'%',  0xAB,  none,  0xAB,	O|T  },
{K_7,	'6',   '&',   none,  none,  A'6',  A'&',  none,  none,  none,	O|T  },
{K_8,	'7',   '_',   none,  none,  A'7',  A'_',  0x9C,  none,  0x9C,	O|T  },
{K_9,	'8',   '(',   none,  none,  A'8',  A'(',  A'{',  none,  '{',	O|T  },
{K_10,	'9',   ')',   none,  none,  A'9',  A')',  A'}',  none,  '}',	O|T  },
{K_11,	'0',   '\'',  none,  none,  A'0',  A'\'', none,  none,  none,	O|T  },
{K_12,	'/',   '?',   none,  none,  A'/',  A'?',  A'\\', A fs,  '\\',	O|T  },
{K_13,	0xF8,  '~',   none,  none,  0xF8,  A'~',  none,  none,  none,	O|T  },
/* key 14 undefined */
...
{K_27,	0xB1,  '^',   rs,    rs,    0xB1,  A'^',  none,  none,  none,	O|T  },
...
{K_32,	's',   'S',   dc3,   dc3,   A's',  A'S',  0xE1,  0xE1,  0xE1,   C|T  },
...
{K_40,	'+',   0xF1,  none,  none,  A'+',  0xF1,  none,  none,  none,	O|T  },
...
{K_45,	']',   '[',   gs,    esc,   A']',  A'[',  A'|',  none,  '|',	O|T  },
{K_46,	'z',   'Z',   sub,   sub,   A'z',  A'Z',  0xAE,  0xAE,  0xAE,   C|T  },
{K_47,	'x',   'X',   can,   can,   A'x',  A'X',  0xAF,  0xAF,  0xAF,   C|T  },
{K_48,	'c',   'C',   etx,   etx,   A'c',  A'C',  0x9B,  0x9B,  0x9B,   C|T  },
