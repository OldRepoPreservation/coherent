 ...
 * 	All rights reserved. May not be copied without permission.
 -lgl) */
/*
 * U.K. standard AT keyboard code table.
 *
 *	See header files for definitions and constants.
 *
 *	Version: 1.2, 01/08/92
 */
#include <sys/kbscan.h>
#include <sys/kb.h>

char	tbl_name[] = "U.K. AT keyboard table";
 ...
 *----  ----   -----  ----   -----  ---    -----  ----   -----  ------- -----*/
{K_1,	'`',   0xAA,  none,  none,  '`',   0xAA,  0xFE,  none,  0xFE,	O|T  },
...
{K_7,	'6',   '^',   rs,    rs,    '6',   '^',   none,  rs,    none,	O|T  },
...
{K_12,	'-',   '_',   us,    us,    '-',   '_',   none,  us,    none,	O|T  },
...
{K_27,	'[',   '{',   esc,   esc,   '[',   '{',   none,  esc,   none,   O|T  },
{K_28,	']',   '}',   gs,    gs,    ']',   '}',   gs,    gs,    none,   O|T  },
{K_29,	'#',   '~',   none,  none,  '#',   '~',   none,  none,  none,   O|T  },
...
{K_41,	'\'',  '@',   nul,   nul,   '\'',  '@',   none,  nul,   none,   O|T  },
