 ...
 * 	All rights reserved. May not be copied without permission.
 -lgl) */
/*
 * U.K. virtual console keyboard code table.
 *
 ...
 *	Version: 1.7, 09/01/93
 */
#include <sys/kbscan.h>
#include <sys/kb.h>

char	tbl_name[] = "U.K. virtual console keyboard table - V1.6";
 ...
 *----  ----   -----  ----   -----  ---    -----  ----   -----  ------- -----*/
{K_1,	'`',   0xAA,  none,  none,  A'`',  0xAA,  0xFE,  none,  0xFE,	O|T  },
{K_2,	'1',   '!',   none,  none,  A'1',  A'!',  none,  none,  none,	O|T  },
{K_3,	'2',   '"',   none,  none,  A'2',  A'"',  none,  none,  none,	O|T  },
{K_4,	'3',   0x9C,  none,  none,  A'3',  0x9C,  none,  none,  none,	O|T  },
{K_5,	'4',   '$',   none,  none,  A'4',  A'$',  none,  none,  none,	O|T  },
{K_6,	'5',   '%',   none,  none,  A'5',  A'%',  none,  none,  none,	O|T  },
{K_7,	'6',   '^',   rs,    rs,    A'6',  A'^',  none,  A rs,  none,	O|T  },
...
{K_12,	'-',   '_',   us,    us,    A'-',  A'_',  none,  A us,  none,	O|T  },
...
{K_27,	'[',   '{',   esc,   esc,   A'[',  A'{',  none,  A esc, none,   O|T  },
...
{K_41,	'\'',  '@',   nul,   nul,   A'\'', A'@',  none,  A nul, none,   O|T  },
...
{K_45,	'\\',  '|',   fs,    fs,    A'\\', A'|',  none,  A fs,  none,   O|T  },
