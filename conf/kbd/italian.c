 ...
 * 	All rights reserved. May not be copied without permission.
 -lgl) */
/*
 * Italian standard AT keyboard code table.
 *
...
char	tbl_name[] = "Italian AT keyboard table";
...
{K_4,	'3',   0x9C,  none,  none,  '3',   0x9C,  none,  none,  none,	O|T  },
...
{K_13,	0x8D,  '^',   none,  none,  0x8D,  '^',   none,  none,  none,	O|T  },
/* key 14 undefined */
...
{K_27,	0x8A,  0x82,  none,  none,  0x8A,  0x82,  '[',   none,  '[',	O|T  },
...
{K_40,	0x95,  0x87,  nul,   nul,   0x95,  0x87,  '@',   nul,   '@',	O|T  },
{K_41,	0x85,  0xF8,  none,  none,  0x85,  0xF8,  '#',   none,  '#',	O|T  },
