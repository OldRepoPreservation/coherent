/* $Source: /usr/local/src/pax/append.c,v $
 *
 * $Revision: 1.2 $
 *
 ...
 *
 * $Log:	/usr/local/src/pax/append.c,v $
 * Revision 1.1  89/02/14  16:47:35  jep
 * Initial revision
 * 
...
#endif
{
    ...
    lseek(archivefd, -((OFFSET) blocksize), 1); /* VLAD. duncing arround bugs */
    create_archive();
}
