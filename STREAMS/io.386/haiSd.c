 ...
 *
 *  Last Modified: Wed Jun  2 14:27:18 1993 by [chris]
 *
...
register int id;
{
    ...
    r->buf. space = KRNL_ADDR;
    r->buf. addr. vaddr = (caddr_t) c->inqbuf;
    ...
    r->buf. space = KRNL_ADDR;
    r->buf. addr. vaddr = (caddr_t) diskcap;
...
char            *vec;
{
    ...
    switch (cmd) {
    case SDGTINQ:
        kucopy(c->inqbuf, vec, sizeof(c->inqbuf));
        break;
    default:
        u. u_error = EINVAL;
        break;
