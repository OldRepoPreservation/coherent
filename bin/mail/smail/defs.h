 ...
 * aliases.  It must begin with a "/" because this string will be
 * appended to the value of $HOME.
 * Added for MWC by La Monte Yarroll, piggy@mwc.com.
 */

#define HOMEALIASES	"/.aliases"
...
#ifndef PATHS
#define PATHS	"/usr/lib/mail/paths"	/* location of the path database */
#endif
